...
class Charity(db.Model):
    ...
    charity_id = db.Column(db.Integer, db.ForeignKey('users.id'))

    #relationship
    users = db.relationship('User', back_populates= 'charities')
    admin = db.relationship('Admin', back_populates= 'charities')
    beneficiary = db.relationship('Beneficiary', back_populates= 'charities')
...
class Admin(db.Model):
    ...
    #relationship
    charities = db.relationship('Charity', back_populates= 'admins')
...
class Beneficiary(db.Model):
    ...
    #relationship
    charities = db.relationship('Charity', back_populates= 'beneficiaries')
    inventories = db.relationship('Inventory', back_populates= 'beneficiaries')
...
class Inventory(db.Model):
    ...
    #relationship
    beneficiaries = db.relationship('Beneficiary', back_populates= 'inventories')
...
class Account(db.Model):
    ...
    #relationship
    charities = db.relationship('Charity', back_populates= 'accounts')