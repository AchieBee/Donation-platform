...
from models import User, Charity, Admin, Beneficiary, Inventory,Account
...
with app.app_context():
 # Seed User
    ...
    # Seed Charity
    charity1 = Charity(name='Charity1', description='Description for Charity1', donation_amount=100,stories='Stories for Charity1', image_url='https://i.pinimg.com/564x/96/59/b6/9659b6909a3416d27c50c875e00a403a.jpg', posted_at=datetime.utcnow(), users=user1)
    db.session.add(charity1)

    charity2 = Charity(name='Charity2', description='Description for Charity2', donation_amount=100,stories='Stories for Charity2', image_url='https://i.pinimg.com/564x/15/90/fe/1590fe78a001ca7856bf1d437a958c4b.jpg', posted_at=datetime.utcnow(), users=user1)
    db.session.add(charity2)

    charity3 = Charity(name='Charity3', description='Description for Charity3', donation_amount=100,stories='Stories for Charity3', image_url='https://i.pinimg.com/564x/60/44/10/6044105d2141ba75b0e39f1e76187b66.jpg', posted_at=datetime.utcnow(), users=user1)
    db.session.add(charity3)

    charity4 = Charity(name='Charity4', description='Description for Charity4', donation_amount=100,stories='Stories for Charity4', image_url='https://i.pinimg.com/564x/73/93/7b/73937bf137b0846a538a4941cdc223f2.jpg', posted_at=datetime.utcnow(), users=user1)
    db.session.add(charity4)

    charity5 = Charity(name='Charity5', description='Description for Charity5', donation_amount=100,stories='Stories for Charity5', image_url='https://images.pexels.com/photos/19069507/pexels-photo-19069507/free-photo-of-smiling-child-by-tree.jpeg?auto=compress&cs=tinysrgb&w=600',  posted_at=datetime.utcnow(), users=user1)
    db.session.add(charity5)

    charity6 = Charity(name='Charity6', description='Description for Charity6', donation_amount=100,stories='Stories for Charity6', image_url='https://i.pinimg.com/564x/d6/7d/b3/d67db34c7eaa0a96008369c216aa94b3.jpg',  posted_at=datetime.utcnow(),users=user1)
