...
from models import User, Charity, Admin, Beneficiary, Inventory,News
...
with app.app_context():
 ...
 # Seed User
    ...
    # Seed Charity
    charity1 = Charity(name='Charity1', description='Description for Charity1', donation_amount=100,stories='Stories for Charity1', image_url='https://i.pinimg.com/564x/96/59/b6/9659b6909a3416d27c50c875e00a403a.jpg', posted_at=datetime.utcnow(), users=user1, paypal_email ='example@gmail.com' ,paypal_no='+254772467546',bank_no='01531637281' ,acc_name='charity',mpesa_paybill='561239' ,mpesa_acc= ' hope1',skrill_country='kenya',skrill_name=' johndoe',phone_no=' +254789663790')
    db.session.add(charity1)

    charity2 = Charity(name='Charity2', description='Description for Charity2', donation_amount=100,stories='Stories for Charity2', image_url='https://i.pinimg.com/564x/15/90/fe/1590fe78a001ca7856bf1d437a958c4b.jpg', posted_at=datetime.utcnow(), users=user1,paypal_email ='example@gmail.com',paypal_no='+254702787546',bank_no='01594655281' ,acc_name='charity',mpesa_paybill='464839 ' ,mpesa_acc= 'hope3',skrill_country='kenya',skrill_name=' johndoe',phone_no=' +254760643790')
    db.session.add(charity2)

    charity3 = Charity(name='Charity3', description='Description for Charity3', donation_amount=100,stories='Stories for Charity3', image_url='https://i.pinimg.com/564x/60/44/10/6044105d2141ba75b0e39f1e76187b66.jpg', posted_at=datetime.utcnow(), users=user1,paypal_email ='example@gmail.com' ,paypal_no=' +254704567546',bank_no='01594630981' ,acc_name='charity',mpesa_paybill='764939' ,mpesa_acc= 'hope4',skrill_country='kenya',skrill_name=' johndoe',phone_no=' +254789689090')
    db.session.add(charity3)

    charity4 = Charity(name='Charity4', description='Description for Charity4', donation_amount=100,stories='Stories for Charity4', image_url='https://i.pinimg.com/564x/73/93/7b/73937bf137b0846a538a4941cdc223f2.jpg', posted_at=datetime.utcnow(), users=user1,paypal_email ='example@gmail.com' ,paypal_no=' +254706767546',bank_no='01570937281' ,acc_name='charity',mpesa_paybill='064439' ,mpesa_acc= 'hope5',skrill_country='kenya ',skrill_name=' johndoe' ,phone_no=' +254789678790')
    db.session.add(charity4)

    charity5 = Charity(name='Charity5', description='Description for Charity5', donation_amount=100,stories='Stories for Charity5', image_url='https://images.pexels.com/photos/19069507/pexels-photo-19069507/free-photo-of-smiling-child-by-tree.jpeg?auto=compress&cs=tinysrgb&w=600',  posted_at=datetime.utcnow(), users=user1,paypal_email='example3@gmail.com',paypal_no='+254706767546',bank_no='01570937281',acc_name='charity',mpesa_paybill='064439',mpesa_acc= 'hope5',skrill_country='kenya',skrill_name='johndoe ',phone_no='+254789678790')
    ...
    admin2 = Admin(fullname='Belza Archie', email='belza44@gmail.com' ,image_url='https://i.pinimg.com/564x/50/2e/20/502e205580c40d854fcb6ec547c7dc14.jpg',charities2=charity3)
    admin2._password_hash='hashed_password'
    db.session.add(admin2)

    admin3 = Admin(fullname='Toby Omondi', email='toby44@gmail.com' ,image_url='https://i.pinimg.com/564x/85/81/42/8581425e8ea241666d6583d1f327fdf8.jpg',charities2=charity4)
    ...
    news2=News(news_title='Climate Conservation',news_image='https://i.pinimg.com/564x/fc/c5/6f/fcc56fb069402b40a9bb680835da37b1.jpg', news_text='The climate conservation  day was a success and we were able to raise a substantial amount in order to achieve the intended goal for climate change awareness and to also organize for a community environment  cleanup . Thanks to all who participated.' ,created_at=datetime.utcnow())
    db.session.add(news2)
    news3=News(news_title='Water for all',news_image='https://i.pinimg.com/564x/57/5c/36/575c363b3d4fd67dea0547ce2cdcb1de.jpg', news_text='On 12th November our partners - Charity Ke were able to dig boreholes for communities in desert-prone areas, through the cause that was posted on our platform. We thank and highly appreciate everybody who participated in the execise and cause.Kudos!' ,created_at=datetime.utcnow())
