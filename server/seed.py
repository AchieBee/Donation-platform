...
with app.app_context():
 ...
 # Seed User
    user1 = User(full_name='John Doe', username='johndoe', email='john@example.com', image_url='https://i.pinimg.com/564x/ca/a7/c0/caa7c0a4efff8ebdf2efd88f0f1cf69a.jpg',user_type='Donation')
    user1._set_password_hash('hashed_password')
    db.session.add(user1)

    user2 = User(full_name='Jane Doe', username='janedoe', email='jane@example.com', image_url='https://i.pinimg.com/564x/df/e4/c7/dfe4c7b7f4aab85f777e091b29b696c7.jpg',user_type='Donation')
    user2.password_hash = 'hashed_password'
    db.session.add(user2)

    user3 = User(full_name='Mary Lee', username='marylee', email='mary@example.com', image_url='https://i.pinimg.com/564x/46/e2/9d/46e29d5be1fb6f3b82014ac7f5289b23.jpg',user_type='Donation')
    user3._set_password_hash('hashed_password')
    db.session.add(user3)

    user4 = User(full_name='John Wick', username='johnwick', email='wick@example.com', image_url='https://i.pinimg.com/564x/26/e6/13/26e613efbf493b816d00f3d36fd4bf9f.jpg',user_type='Donation')
    user4._set_password_hash('hashed_password')
    db.session.add(user4)

    user5 = User(full_name='Joe Cole', username='joecole', email='joe@example.com', image_url='https://i.pinimg.com/564x/11/42/52/1142520b864cebc5f30b650404d86359.jpg',user_type='Donation')
    user5._set_password_hash('hashed_password')
    db.session.add(user5)

    user6 = User(full_name='Anne Louis', username='annelou', email='anne@example.com', image_url='https://i.pinimg.com/564x/2e/58/88/2e5888ed9cf3ac1c5bbbaf523d9dda57.jpg',user_type='Donation')
    user6._set_password_hash('hashed_password')
